...
document.getElementById("payment").addEventListener("submit", function(event) {
  ...
  var orderId = "K" + Math.floor(Math.random() * 10000);

  var tableBody = document.getElementById("history-table");
  var newRow = tableBody.insertRow();

  newRow.innerHTML = "<td>" + orderId + "</td><td style='text-align: start;'>" + status + "</td>";


  alert("Order with ID " + orderId + " has been booked successfully.");
